...
<label for="allergy"> {{'competences.allergie.title' | translate}} </label>
<div id="allergy" class="btn-group-toggle col-sm-12 col-md-12" data-toggle="buttons">
    <label class="btn btn-outline-secondary">
      ...
      {{'competences.allergie.yes' | translate}}
     </label>
     <label class="btn btn-outline-secondary">
     <input type="radio" ng-model="personne.allergie"  value="Non">
      {{'competences.allergie.no' | translate}}
     </label>
</div>
